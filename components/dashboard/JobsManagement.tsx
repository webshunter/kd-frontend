...
import { jobService, Job, JobCategory } from '../../src/services/jobService';
...
const JobsManagement: React.FC = () => {
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                ...
                setError('Gagal memuat data lowongan kerja. Silakan coba lagi.');
            } finally {
                setLoading(false);
            }
        };
    ...
    const filteredJobs = (jobs || []).filter(job => {
        ...
        const matchesCategory = selectedCategory === 'all' || 
            job.category_slug === selectedCategory;
    ...
    const getStatusBadge = (job: Job) => {
        const statusConfig = {
            active: { color: 'bg-green-100 text-green-800 border-green-200', label: 'Active', icon: 'check_circle' },
            closed: { color: 'bg-red-100 text-red-800 border-red-200', label: 'Closed', icon: 'cancel' },
            draft: { color: 'bg-yellow-100 text-yellow-800 border-yellow-200', label: 'Draft', icon: 'edit' },
            paused: { color: 'bg-gray-100 text-gray-800 border-gray-200', label: 'Paused', icon: 'pause' }
        };
    ...
    const formatSalary = (minSalary: number | string | null, maxSalary: number | string | null) => {
        if (!minSalary && !maxSalary) return 'Gaji Dirahasiakan';
        ...
        if (minSalary) {
            return `Rp ${formatNumber(minSalary)}+`;
        }
        return `Hingga Rp ${formatNumber(maxSalary!)}`;
    };
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="flex flex-col items-center">
                    ...
                    <p className="mt-4 text-gray-600 font-medium">Memuat data lowongan kerja...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Manajemen Lowongan Kerja</h1>
                            <p className="mt-2 text-gray-600">Kelola lowongan kerja dan kategori dengan mudah</p>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    ...
                    <div className="bg-white rounded-lg shadow-sm border p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <p className="text-sm font-medium text-gray-500">Total Aplikasi</p>
                ...
                <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">Cari Lowongan</label>
                                    ...
                                    <tr key={job.id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span
                                                ...
                                                style={{
                                                    backgroundColor: job.category_color + '20',
                                                    color: job.category_color,
                                                    border: `1px solid ${job.category_color}40`
                                                }}
                                            >
                                                {job.category_name}
                                            </span>
                            ...
                            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                <div>
                                    <p className="text-sm text-gray-700">
                                        ...
                                        <span className="font-medium">{Math.min(endIndex, filteredJobs.length)}</span> dari{' '}
                                        <span className="font-medium">{filteredJobs.length}</span> hasil
                                    </p>
                                </div>
                                <div>
                        ...
                        <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                            <div className="p-6">
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-gray-600 font-medium">Form untuk menambah lowongan baru akan segera tersedia.</p>
                                </div>
                            </div>
                        </div>
                    </div>
