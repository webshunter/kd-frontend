...
import { businessMatchingService, BusinessProfile, BusinessCategory } from '../../src/services/businessMatchingService';

const BusinessMatchingManagement: React.FC = () => {
        ...
        const loadData = async () => {
            try {
                ...
                const [profilesData, categoriesData] = await Promise.all([
                    businessMatchingService.getProfiles({ limit: 100 }),
                    businessMatchingService.getCategories()
                ]);
                setProfiles(profilesData.profiles);
                setCategories(categoriesData);
            } catch (err: any) {
                console.error('Error loading business matching data:', err);
                setError('Gagal memuat data business matching. Silakan coba lagi.');
            } finally {
                setLoading(false);
            }
        };
    ...
    const filteredProfiles = (profiles || []).filter(profile => {
        ...
        const matchesCategory = selectedCategory === 'all' || 
            profile.category_slug === selectedCategory;
    ...
    const getStatusBadge = (profile: BusinessProfile) => {
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="flex flex-col items-center">
                    ...
                    <p className="mt-4 text-gray-600 font-medium">Memuat data business matching...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Manajemen Business Matching</h1>
                            <p className="mt-2 text-gray-600">Kelola profil bisnis dan kategori dengan mudah</p>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div className="bg-white rounded-lg shadow-sm border p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <p className="text-sm font-medium text-gray-500">Total Profil</p>
                        ...
                        <div className="flex items-center">
                            <div className="flex-shrink-0">
                                <div className="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center">
                                    <span className="material-symbols-outlined text-purple-600">handshake</span>
                                </div>
                            </div>
                            <div className="ml-4">
                                <p className="text-sm font-medium text-gray-500">Koneksi</p>
                                <p className="text-2xl font-bold text-gray-900">
                                    {profiles.reduce((sum, profile) => sum + profile.connection_count, 0)}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">Cari Profil</label>
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    placeholder="Cari nama bisnis, industri, atau deskripsi..."
                                    value={searchTerm}
                            ...
                            <thead className="bg-gray-50">
                                <tr>
                                    <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        <div className="flex items-center">
                                            <span className="material-symbols-outlined mr-2 text-sm">business</span>
                                            Profil Bisnis
                                        </div>
                                    </th>
                                    <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    ...
                                    <tr key={profile.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <div className="flex items-center">
                                                <div className="flex-shrink-0 h-12 w-12">
                                                    <img
                                                        ...
                                                        src={profile.logo_url || 'https://picsum.photos/48/48?random=' + Math.random()}
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span
                                                ...
                                                style={{
                                                    backgroundColor: profile.category_color + '20',
                                                    color: profile.category_color,
                                                    border: `1px solid ${profile.category_color}40`
                                                }}
                                            >
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center text-sm text-gray-900">
                                                <span className="material-symbols-outlined text-sm mr-1 text-gray-400">handshake</span>
                            ...
                            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                <div>
                                    <p className="text-sm text-gray-700">
                                        ...
                                        <span className="font-medium">{Math.min(endIndex, filteredProfiles.length)}</span> dari{' '}
                                        <span className="font-medium">{filteredProfiles.length}</span> hasil
                                    </p>
                                </div>
                                <div>
                        ...
                        <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                            <div className="p-6">
                                <div className="flex justify-between items-center mb-4">
                                    <h2 className="text-xl font-bold text-gray-900">Tambah Profil Bisnis Baru</h2>
                                    <button
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-gray-600 font-medium">Form untuk menambah profil bisnis baru akan segera tersedia.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default BusinessMatchingManagement;