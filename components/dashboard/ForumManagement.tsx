...
import { forumService, ForumTopic, ForumCategory } from '../../src/services/forumService';
...
const ForumManagement: React.FC = () => {
        ...
        const loadData = async () => {
            try {
                ...
                const [topicsData, categoriesData] = await Promise.all([
                    forumService.getTopics({ limit: 100 }),
    ...
    const filteredTopics = (topics || []).filter(topic => {
        ...
        const matchesCategory = selectedCategory === 'all' || 
            topic.category_slug === selectedCategory;
    ...
    const getStatusBadge = (topic: ForumTopic) => {
        if (topic.is_pinned) {
            return (
        ...
        return (
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border bg-green-100 text-green-800 border-green-200">
                <span className="material-symbols-outlined text-xs mr-1">chat</span>
                Active
            </span>
        );
    };
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="flex flex-col items-center">
                    ...
                    <p className="mt-4 text-gray-600 font-medium">Memuat data forum...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p className="mt-2 text-gray-600">Kelola topik dan kategori forum dengan mudah</p>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div className="bg-white rounded-lg shadow-sm border p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <p className="text-sm font-medium text-gray-500">Total Topik</p>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <p className="text-sm font-medium text-gray-500">Total Balasan</p>
                                <p className="text-2xl font-bold text-gray-900">
                                    {topics.reduce((sum, topic) => sum + topic.reply_count, 0).toLocaleString()}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-2xl font-bold text-gray-900">
                                    {topics.reduce((sum, topic) => sum + topic.view_count, 0).toLocaleString()}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">Cari Topik</label>
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        <div className="flex items-center">
                                            <span className="material-symbols-outlined mr-2 text-sm">reply</span>
                                            Balasan
                                        </div>
                                    </th>
                                    <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    ...
                                    <tr key={topic.id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span
                                                ...
                                                style={{
                                                    ...
                                                    border: `1px solid ${topic.category_color}40`
                                                }}
                                            >
                                                {topic.category_name}
                                            </span>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center text-sm text-gray-900">
                                                <span className="material-symbols-outlined text-sm mr-1 text-gray-400">reply</span>
                                                {topic.reply_count}
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm text-gray-900">
                                                {topic.last_reply_at ? formatDate(topic.last_reply_at) : formatDate(topic.created_at)}
                                            </div>
                                            {topic.last_reply_author_name && (
                                                <div className="text-xs text-gray-500">
                                                    by {topic.last_reply_author_name}
                                                </div>
                                            )}
                                        </td>
                            ...
                            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                <div>
                                    <p className="text-sm text-gray-700">
                                        ...
                                        <span className="font-medium">{Math.min(endIndex, filteredTopics.length)}</span> dari{' '}
                                        <span className="font-medium">{filteredTopics.length}</span> hasil
                                    </p>
                                </div>
                                <div>
                        ...
                        <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                            <div className="p-6">
                                <div className="flex justify-between items-center mb-4">
                                    <h2 className="text-xl font-bold text-gray-900">Tambah Topik Baru</h2>
                                    <button
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-gray-600 font-medium">Form untuk menambah topik baru akan segera tersedia.</p>
                                </div>
                            </div>
                        </div>
                    </div>
