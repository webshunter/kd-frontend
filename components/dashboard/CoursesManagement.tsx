...
import { courseService, Course, CourseCategory } from '../../src/services/courseService';
...
const CoursesManagement: React.FC = () => {
    ...
    const filteredCourses = (courses || []).filter(course => {
        ...
        const matchesCategory = selectedCategory === 'all' || 
            course.category_slug === selectedCategory;
    ...
    const formatPrice = (price: number | string | null, isFree: boolean) => {
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="flex flex-col items-center">
                    ...
                    <p className="mt-4 text-gray-600 font-medium">Memuat data kursus...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p className="mt-2 text-gray-600">Kelola kursus dan kategori dengan mudah</p>
                        </div>
                ...
                <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">Cari Kursus</label>
                                            ...
                                            <div className="flex items-center">
                                                <div className="flex-shrink-0 h-12 w-12">
                                                    <img
                                                        ...
                                                        src={course.thumbnail_url || 'https://picsum.photos/48/48?random=' + Math.random()}
                                                        alt={course.title}
                                                    />
                                                </div>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span
                                                ...
                                                style={{
                                                    ...
                                                    border: `1px solid ${course.category_color}40`
                                                }}
                                            >
                            ...
                            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                <div>
                                    <p className="text-sm text-gray-700">
                                        ...
                                        <span className="font-medium">{Math.min(endIndex, filteredCourses.length)}</span> dari{' '}
                                        <span className="font-medium">{filteredCourses.length}</span> hasil
                                    </p>
                                </div>
                                <div>
                        ...
                        <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                            <div className="p-6">
                                <div className="flex justify-between items-center mb-4">
                                    <h2 className="text-xl font-bold text-gray-900">Tambah Kursus Baru</h2>
                                    <button
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-gray-600 font-medium">Form untuk menambah kursus baru akan segera tersedia.</p>
                                </div>
                            </div>
                        </div>
                    </div>
